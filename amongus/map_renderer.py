...
class MapLayout:
    ...
    def _initialize_skeld_map(self):
        room_definitions = [
            ...
            ("Reactor", 45, 180, 113, 90, ["Security", "Upper Engine", "Lower Engine"], True, ["Start Reactor", "Unlock Manifolds"], True),
            ("Security", 195, 180, 105, 83, ["Electrical", "Reactor", "Upper Engine"], True, ["Fix Wiring"], False),
            ...
            ("Electrical", 45, 315, 128, 90, ["Storage", "Lower Engine", "Security"], True, ["Fix Wiring", "Download Data", "Divert Power"], True),
            ...
            ("Lower Engine", 45, 443, 128, 98, ["Electrical", "Security", "Reactor"], True, ["Align Engine Output", "Fuel Engines"], True),
